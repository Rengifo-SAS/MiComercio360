-- Agregar campo tax_id a la tabla products para vincular con el módulo de impuestos
-- 048_add_tax_id_to_products.sql
...
-- Agregar comentario
COMMENT ON COLUMN public.products.tax_id IS 'Impuesto principal del producto (referencia a taxes)';

-- Actualizar función create_product_with_inventory para incluir tax_id
...
-- Actualizar función update_product para incluir tax_id y cost_center_id
