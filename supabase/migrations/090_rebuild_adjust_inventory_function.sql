-- Migración para reconstruir completamente la función de ajuste de inventario
-- Esta migración elimina todas las versiones anteriores y crea una versión limpia y funcional
...
DROP FUNCTION IF EXISTS public.adjust_inventory(uuid, numeric, text);

-- Crear la función adjust_inventory completamente nueva y funcional
...
BEGIN
    ...
    IF v_warehouse_quantity IS NULL THEN
        INSERT INTO public.warehouse_inventory (
            ...
            p_product_id, v_warehouse_id, 0, v_company_id, now(), auth.uid()
        );
    ...
    INSERT INTO public.inventory_movements (
        ...
        p_product_id, v_warehouse_id, 'ADJUSTMENT', v_difference,
...
-- Crear comentario para la función
COMMENT ON FUNCTION public.adjust_inventory(uuid, integer, text) IS 
'Función para ajustar el inventario de un producto. Actualiza tanto warehouse_inventory como inventory.';

-- Verificar que la función se creó correctamente
SELECT 'Función adjust_inventory creada exitosamente' as status;
