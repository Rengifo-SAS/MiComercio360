-- Migración definitiva para corregir el error de ON CONFLICT en adjust_inventory
-- Esta migración corrige el orden de las columnas en INSERT para que coincida con el constraint único
