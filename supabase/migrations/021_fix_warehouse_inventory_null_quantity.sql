-- Corregir problemas con valores null en warehouse_inventory
-- Aplicar COALESCE para evitar valores null en la columna quantity

-- Actualizar función create_warehouse_transfer (versión 018)
