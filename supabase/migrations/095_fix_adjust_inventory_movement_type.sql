-- Corregir la función adjust_inventory para usar el tipo de movimiento correcto
-- El constraint check requiere 'adjustment' en minúsculas, no 'ADJUSTMENT' en mayúsculas
...
BEGIN
    ...
    -- Crear movimiento de inventario (usando 'adjustment' en minúsculas)
