...
-- El problema está en el manejo del ON CONFLICT en warehouse_inventory

-- Función completamente reescrita para transferencias
...
-- Función para sincronizar productos con warehouse_inventory
