...
fs.writeFileSync('scripts/migration-pos-config.sql', createPosConfigSQL);

console.log('✅ Archivo SQL de migración generado: scripts/migration-pos-config.sql');
console.log('');
console.log('📝 Para aplicar la migración, ejecute uno de los siguientes comandos:');
console.log('');
console.log('1. Si tiene acceso directo a la base de datos PostgreSQL:');
console.log('   psql -h localhost -p 54322 -U postgres -d postgres -f scripts/migration-pos-config.sql');
console.log('');
console.log('2. Si está usando Supabase CLI:');
console.log('   supabase db reset');
console.log('   (Esto aplicará todas las migraciones incluyendo la nueva)');
console.log('');
console.log('3. Copie y pegue el contenido del archivo en el SQL Editor de Supabase Dashboard');
console.log('');
console.log('📁 Archivo generado: scripts/migration-pos-config.sql');
