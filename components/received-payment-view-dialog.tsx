...
interface ReceivedPaymentViewDialogProps {
  receivedPayment: ReceivedPayment;
  trigger?: React.ReactNode;
}

export function ReceivedPaymentViewDialog({
  receivedPayment,
  trigger,
}: ReceivedPaymentViewDialogProps) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Detalles de Pago Recibido</DialogTitle>
          <DialogDescription>
            Información completa del pago recibido
          </DialogDescription>
        </DialogHeader>
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <p className="font-medium">
                  {receivedPayment.customer?.business_name || 'N/A'}
                </p>
              </div>
            </div>
            <div>
