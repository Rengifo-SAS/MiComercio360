...
import { TrialBalanceReportClient } from '@/components/trial-balance-report-client';

export const metadata = {
  title: 'Balance de Prueba | POS-SRSAS',
...
export default async function TrialBalanceReportPage() {
  ...
  return (
    <RouteGuard requiredPermission="reports.read">
      <TrialBalanceReportClient companyId={setupStatus.company.id} userId={user.id} />
    </RouteGuard>
  );
}
