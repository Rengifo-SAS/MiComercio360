...
import { InventoryValueReportClient } from '@/components/inventory-value-report-client';

export const metadata = {
  title: 'Valor de inventario | POS-SRSAS',
  description: 'Reporte de valor de inventario',
};
